...
public:
    ...
    void rotate_left(float delta_time, float rotation_speed);
    void rotate_right(float delta_time, float rotation_speed);
    void handle_movement(float delta_time, float rotation_speed);
